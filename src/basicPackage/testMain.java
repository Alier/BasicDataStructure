...
//		int[] postorder = new int[]{1,3,2,5,6,10,9,8,7,4};
		int[] preorder = new int[]{3,1,2,6,4,5,7};
		
		//swap right tree node with root
		int[] inorder2 = new int[]{1,2,4,3,5,6,7};
		int[] preorder2 = new int[]{4,1,2,6,3,5,7};
>>>>>>> 9ca04a63c98a4c6e4227d7b560a6b4a0beea389d
...
=======
		binarySearchTree newTree = new binarySearchTree(preorder,inorder);
		binarySearchTree newTree2 = new binarySearchTree(preorder2,inorder2);
//		binarySearchTree newTree = new binarySearchTree();
//		ArrayList<treeNode> roots = newTree.generateTrees(4);
//		for(int i=0;i<roots.size();i++) {
//			System.out.println("Tree "+i);
//			newTree.printTree(roots.get(i),2);
//			System.out.println();
//		}
>>>>>>> 9ca04a63c98a4c6e4227d7b560a6b4a0beea389d
...
=======
		...
		newTree.printTree(newTree.getRoot(),1);
		System.out.println();
		System.out.println("======Pre-order======= node count:"+newTree.nodeCount);
		newTree.printTree(newTree.getRoot(),2);
		System.out.println();
		System.out.println("======In-order Tree2======= node count:"+newTree2.nodeCount);
		newTree.printTree(newTree2.getRoot(),1);
		System.out.println();
		System.out.println("======Pre-order Tree2======= node count:"+newTree2.nodeCount);
		newTree2.printTree(newTree2.getRoot(),2);
		System.out.println();
		newTree2.recoverTree(newTree2.getRoot());
		System.out.println("After recover tree2");
		System.out.println("======In-order Tree2======= node count:"+newTree2.nodeCount);
		newTree.printTree(newTree2.getRoot(),1);
		System.out.println();
		System.out.println("======Pre-order Tree2======= node count:"+newTree2.nodeCount);
